...
class ViewHolderRepuestos(view: View): RecyclerView.ViewHolder(view) {
    ...
    init {
        ...
        println("ViewHolder initialized: txtNombreRepuesto = ${txtNombreRepuesto}, imgRepuesto = ${imgRepuesto}, txtPrecio = ${txtPrecio}, txtCategoria = ${txtCategoria}, imgActuRep = ${imgActuRep}, imgBorrarRep = ${imgBorrarRep}")
    }
}